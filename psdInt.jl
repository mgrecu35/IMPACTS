...
function nw_lambd(swc,nc,mu,bscat,ext,scat,g,vfall,Deq,wl)
    ...
    return W, log10(Z*fact)*10., att, log10(n0/0.08e8), nc0, vdop/Z, m4/m3
end
...
function nw_lambd_1M(swc,dn,mu,bscat,ext,scat,g,vfall,Deq,wl)
    ...
    return W, Zn, att, log10(n0/0.08e8), nc0, vdop/Z, scattPSD, gPSD/scattPSD, m4/m3
end
...
function nw_lambd_1Ms(swc,dn,mu,bscat,ext,scat,g,vfall,vfall_r,Deq,Deq_r,wl)
    ...
    spl5=Spline1D(Deq,vfall)  #m/s
    vfallInt=spl5(Dint)
    spl5_r=Spline1D(Deq_r,vfall_r)  #m/s
...
function get_fZr(zObs,bscat_r,scat_r,ext_r,g_r,Deq_r,vfall_r,wl,dn,mu)
    ...
    for it=1:6
        ...
        scatInt,gInt,dm=nw_lambd_1M(rwc1,dn,mu,bscat_r[9,:],
                                 ext_r[9,:],
                                 scat_r[9,:],g_r[9,:],
                                 vfall_r[:],Deq_r[:],wl)
    ...
    return rwc, Z, att,scatInt,gInt, vdop, dm
...
function get_fZm(f,zObs,ns,bscat_r,scat_r,ext_r,g_r,Deq_r,vfall_r,
    ...
    for it=1:6
        ...
        scatIntr,gIntr,dm=nw_lambd_1M(f*rwc1,dn,mu,bscat_r[9,:],
                                 ext_r[9,:],
                                 scat_r[9,:],g_r[9,:],
                                   vfall_r[:],Deq_r[:],wl)
        ws1,Zs1,atts1,dns11,ncs1,vdops1,
        scatInts1,gInts1,dm=nw_lambd_1M((1-f)*rwc1,dn,mu,bscat[end,ns,:],ext[end,ns,:],
                                   scat[end,ns,:],g[end,ns,:],
                                   vfall[ns,:],Deq[ns,:],wl)
...
function get_fZs(zObs,ns,bscat,scat,ext,g,Deq,Deq_r,vfall,vfall_r,wl,dn,mu)
    ...
    for it=1:6
        ...
        w1,Z1,att1,dn11,nc1,vdop1,
        scatInt,gInt,dm=nw_lambd_1Ms(rwc1,dn,mu,bscat[end,ns,:],
                                              ext[end,ns,:],
                                              scat[end,ns,:],g[end,ns,:],
                                              vfall[ns,:],vfall_r,Deq[ns,:],Deq_r,wl)
    ...
    w,Z,att,dn1,nc,vdop,
    scatInt,gInt,dm=nw_lambd_1Ms(rwc,dn,mu,bscat[end,ns,:],
                             ext[end,ns,:],
                             scat[end,ns,:],g[end,ns,:],
                             vfall[ns,:],vfall_r,Deq[ns,:],Deq_r,wl)
